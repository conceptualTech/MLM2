<%@ Page Title="" Language="C#" MasterPageFile="~/UserPannel/USER.Master" AutoEventWireup="true" CodeFile="InboxMessage.aspx.cs" Inherits="MLM.UserPannel.InboxMessage" %>
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="home">
                          ...
                          <p class="lead"> <span class="fa fa-thumb-tack"> <asp:Label ID="lblSubject" runat="server" Text="Subject" ></asp:Label></span></p>
                           From:  <asp:Label ID="lblFrom" runat="server" Text="From" ></asp:Label>
                                <br/>
                            <br/>
