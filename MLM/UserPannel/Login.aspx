<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="MLM.UserPannel.Login" %>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
              ...
              <h1>Login Form</h1>
              <asp:Label ID="Label1" runat="server" style="color:indianred" ></asp:Label>
              <br/>
                <div>
                   <asp:TextBox  ID="username"  runat="server" class="form-control" Text="BTCN0UX" ></asp:TextBox>
              </div>
              <br/>
              <div>
                   <asp:TextBox  ID="password" TextMode="Password" runat="server" class="form-control" Text="12" ></asp:TextBox>
              </div>
