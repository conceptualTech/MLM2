<%@ Page Title="" Language="C#" MasterPageFile="~/UserPannel/USER.Master" AutoEventWireup="true" CodeFile="joining_report.aspx.cs" Inherits="MLM.UserPannel.joining_report" %>
                ...
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div class="form-group">
                            <asp:TextBox ID="dtpDaily" runat="server" class="form-control" TextMode="Date"></asp:TextBox>
                    </div>
                </div>
                        <div class='col-sm-3'>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    From Date<span style="color:red">*</span>
                     <div class="form-group">
                            <asp:TextBox ID="dtpFrom" runat="server" class="form-control" TextMode="Date" ></asp:TextBox>
                        </div>
                   </div>
                   ...
                   To Date<span style="color:red">*</span>
                    <div class="form-group">
                            <asp:TextBox ID="dtpTo" runat="server" class="form-control" TextMode="Date" ></asp:TextBox>
                        </div>
                    </div>
                     ...
                     <div class="x_content">
                          ...
                          <Columns>
                              ...
                              <asp:TemplateField HeaderText="#">
                               ...
                               <asp:BoundField DataField="date_of_joining" HeaderText="Date of Joining" ReadOnly="True" SortExpression="Date" />
