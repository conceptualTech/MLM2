...
namespace MLM
{
    public partial class search_member : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "Select * From add_new_member where client_name like '%"+txtSearch.Text+"%' or city like '%"+txtSearch.Text+"%' or mobile_number like '%"+txtSearch.Text+ "%' and  approve_disapprove_status='Approve'";
            cmd.Connection = con;
