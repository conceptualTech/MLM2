<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN.Master" AutoEventWireup="true" CodeFile="total_payout_report.aspx.cs" Inherits="MLM.total_payout_report" %>
            ...
            <div class="row">
              <div class="col-md-12 col-xs-12">
                ...
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <div class="x_content">
                    <div class=' col-xs-12'>User Payout Report</div>
                        <div class="col-sm-6">
                       <asp:Button ID="Button2" runat="server" Text="View" class="btn btn-danger"  />
                        </div>
                    </div>
                </div>
              ...
              <div class="col-md-6 col-xs-12">
                <div class="x_panel" style="height:147px">
                  <div class="x_title">
                    <h2>Member-Wise Payout Report </h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Weekly/Monthly Payout Report </h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a class="close-link"><i class="fa fa-close"></i></a>
